...
public class BloodDonationApplication {
	...
	// servicios de persona
	 private static void testPersonService(PersonService personService) {
		...
		// newPerson.setPhone("1234561189"); // Puedes establecer el teléfono según tus necesidades
		// newPerson.setEmail("nuevousuario@example.com"); // Puedes establecer el correo electrónico según tus necesidades
