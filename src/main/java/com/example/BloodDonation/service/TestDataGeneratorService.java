...
public class TestDataGeneratorService {
    ...
    private void generatePersons() throws ParseException {
        ...
        Person person = Person.builder()
                ...
                .role(null)
                .unitsPerson(null) 
                .transfusionsPerson(null)
                .transfusions2Person(null)
                .eventsPerson(null)
                .eventsRecordPerson(null)
                .build();
        ...
        Date donation2 = new SimpleDateFormat("yyyy-MM-dd").parse("2020-11-15");
        ...
        Date donation5 = new SimpleDateFormat("yyyy-MM-dd").parse("2022-01-20");
        ...
        Date donation8 = new SimpleDateFormat("yyyy-MM-dd").parse("2021-11-15");
        ...
        Date donation11 = new SimpleDateFormat("yyyy-MM-dd").parse("2022-03-05");
        ...
        Date donation12 = new SimpleDateFormat("yyyy-MM-dd").parse("2021-12-10");
        ...
        Date donation17 = new SimpleDateFormat("yyyy-MM-dd").parse("2022-02-14");
        ...
        Date donation19 = new SimpleDateFormat("yyyy-MM-dd").parse("2022-03-10");
    ...
    private void generateBloodUnits() {
        // Inserta unidades de sangre aquí
        // Ejemplo:
        ...
        // Unidad de sangre 3
        Person donor3 = personService.getPersonById(3).orElse(null);
        if (donor3 != null) {
        ...
        // Unidad de sangre 4
        Person donor4 = personService.getPersonById(4).orElse(null);
        if (donor4 != null) {
        ...
        // Unidad de sangre 5
        Person donor5 = personService.getPersonById(5).orElse(null);
        if (donor5 != null) {
        ...
        // Unidad de sangre 6
        Person donor6 = personService.getPersonById(6).orElse(null);
        if (donor6 != null) {
        ...
        // Unidad de sangre 7
        Person donor7 = personService.getPersonById(7).orElse(null);
        if (donor7 != null) {
        ...
        // Unidad de sangre 8
        Person donor8 = personService.getPersonById(8).orElse(null);
        if (donor8 != null) {
        ...
        // Unidad de sangre 9
        Person donor9 = personService.getPersonById(9).orElse(null);
        if (donor9 != null) {
        ...
        // Unidad de sangre 10
        Person donor10 = personService.getPersonById(10).orElse(null);
        if (donor10 != null) {
        ...
        // Unidad de sangre 11
        Person donor11 = personService.getPersonById(11).orElse(null);
        if (donor11 != null) {
        ...
        // Unidad de sangre 12
        Person donor12 = personService.getPersonById(12).orElse(null);
        if (donor12 != null) {
        ...
        // Unidad de sangre 13
        Person donor13 = personService.getPersonById(13).orElse(null);
        if (donor13 != null) {
        ...
        // Unidad de sangre 14
        Person donor14 = personService.getPersonById(14).orElse(null);
        if (donor14 != null) {
        ...
        // Unidad de sangre 15
        Person donor15 = personService.getPersonById(15).orElse(null);
        if (donor15 != null) {
        ...
        // Unidad de sangre 16
        Person donor16 = personService.getPersonById(16).orElse(null);
        if (donor16 != null) {
        ...
        // Unidad de sangre 17
        Person donor17 = personService.getPersonById(17).orElse(null);
        if (donor17 != null) {
        ...
        // Unidad de sangre 18
        Person donor18 = personService.getPersonById(18).orElse(null);
        if (donor18 != null) {
        ...
        // Unidad de sangre 19
        Person donor19 = personService.getPersonById(19).orElse(null);
        if (donor19 != null) {
        ...
        // Unidad de sangre 20
        Person donor20 = personService.getPersonById(20).orElse(null);
        if (donor20 != null) {
    ...
    private void generateAnalysisResults() {
        ...
        if (bloodUnit != null) {
            ...
            AnalysisResult analysisResult = AnalysisResult.builder()
                    ...
                    .result("Normal")
                    .analysis_date(Date.from(analysisDate.atZone(ZoneId.systemDefault()).toInstant()))
...
BloodUnit bloodUnit1 = bloodUnitService.getBloodUnitById(1).orElse(null);
if (bloodUnit1 != null) {
    ...
    AnalysisResult analysisResult1 = AnalysisResult.builder()
            ...
            .analysis_type("Blood Test")
            .result("Normal")
            .analysis_date(Date.from(analysisDate1.atZone(ZoneId.systemDefault()).toInstant()))
            .observations("No observations")
            .build();
...
if (bloodUnit2 != null) {
    ...
    AnalysisResult analysisResult2 = AnalysisResult.builder()
            ...
            .result("High")
            .analysis_date(Date.from(analysisDate2.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit3 != null) {
    ...
    AnalysisResult analysisResult3 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate3.atZone(ZoneId.systemDefault()).toInstant()))
            .observations("No observations")
            .build();
...
if (bloodUnit4 != null) {
    ...
    AnalysisResult analysisResult4 = AnalysisResult.builder()
            ...
            .result("Low")
            .analysis_date(Date.from(analysisDate4.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit5 != null) {
    ...
    AnalysisResult analysisResult5 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate5.atZone(ZoneId.systemDefault()).toInstant()))
            .observations("No observations")
            .build();
...
if (bloodUnit6 != null) {
    ...
    AnalysisResult analysisResult6 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate6.atZone(ZoneId.systemDefault()).toInstant()))
            .observations("No observations")
            .build();
...
if (bloodUnit7 != null) {
    ...
    AnalysisResult analysisResult7 = AnalysisResult.builder()
            ...
            .result("Low")
            .analysis_date(Date.from(analysisDate7.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit8 != null) {
    ...
    AnalysisResult analysisResult8 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate8.atZone(ZoneId.systemDefault()).toInstant()))
            .observations("No observations")
            .build();
...
if (bloodUnit9 != null) {
    ...
    AnalysisResult analysisResult9 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate9.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit10 != null) {
    ...
    AnalysisResult analysisResult10 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate10.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit11 != null) {
    ...
    AnalysisResult analysisResult11 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate11.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit12 != null) {
    ...
    AnalysisResult analysisResult12 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate12.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit13 != null) {
    ...
    AnalysisResult analysisResult13 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate13.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit14 != null) {
    ...
    AnalysisResult analysisResult14 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate14.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit15 != null) {
    ...
    AnalysisResult analysisResult15 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate15.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit16 != null) {
    ...
    AnalysisResult analysisResult16 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate16.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit17 != null) {
    ...
    AnalysisResult analysisResult17 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate17.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit18 != null) {
    ...
    AnalysisResult analysisResult18 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate18.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit19 != null) {
    ...
    AnalysisResult analysisResult19 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate19.atZone(ZoneId.systemDefault()).toInstant()))
...
if (bloodUnit20 != null) {
    ...
    AnalysisResult analysisResult20 = AnalysisResult.builder()
            ...
            .result("Normal")
            .analysis_date(Date.from(analysisDate20.atZone(ZoneId.systemDefault()).toInstant()))
    ...
    private void generateDonationEvents() throws ParseException {
        ...
        DonationEvent donationEvent11 = DonationEvent.builder()
                ...
                .city("City A")
                .address("Address A")
                .description("Spring Blood Drive")
                .status_event("Scheduled")
                .build();
        ...
        DonationEvent donationEvent12 = DonationEvent.builder()
                ...
                .city("City B")
                .address("Address B")
                .description("Community Blood Donation")
        ...
        DonationEvent donationEvent14 = DonationEvent.builder()
                ...
                .city("City D")
                .address("Address D")
                .description("School Blood Donation")
                .status_event("Scheduled")
                .build();
        ...
        DonationEvent donationEvent15 = DonationEvent.builder()
                ...
                .city("City E")
                .address("Address E")
                .description("Corporate Blood Drive")
                .status_event("In Progress")
                .build();
        ...
        DonationEvent donationEvent16 = DonationEvent.builder()
                ...
                .city("City F")
                .address("Address F")
                .description("Hospital Blood Donation")
                .status_event("Completed")
                .build();
        ...
        DonationEvent donationEvent18 = DonationEvent.builder()
                ...
                .city("City H")
                .address("Address H")
                .description("Summer Blood Drive")
                .status_event("In Progress")
                .build();
    ...
    private void generateDonationRecordEvents() {
        ...
        // 1
        Person donor1 = personService.getPersonById(1).orElse(null);
        DonationEvent event1 = donationEventService.getDonationEventById(1).orElse(null);
        BloodUnit unit1 = bloodUnitService.getBloodUnitById(1).orElse(null);
        ...
        BloodUnit unit2 = bloodUnitService.getBloodUnitById(2).orElse(null);
        ...
        BloodUnit unit3 = bloodUnitService.getBloodUnitById(3).orElse(null);
        ...
        BloodUnit unit4 = bloodUnitService.getBloodUnitById(4).orElse(null);
        ...
        BloodUnit unit5 = bloodUnitService.getBloodUnitById(5).orElse(null);
        ...
        BloodUnit unit6 = bloodUnitService.getBloodUnitById(6).orElse(null);
        ...
        BloodUnit unit7 = bloodUnitService.getBloodUnitById(7).orElse(null);
        ...
        BloodUnit unit8 = bloodUnitService.getBloodUnitById(8).orElse(null);
        ...
        BloodUnit unit9 = bloodUnitService.getBloodUnitById(9).orElse(null);
        ...
        BloodUnit unit11 = bloodUnitService.getBloodUnitById(11).orElse(null);
        ...
        BloodUnit unit12 = bloodUnitService.getBloodUnitById(12).orElse(null);
        ...
        BloodUnit unit13 = bloodUnitService.getBloodUnitById(13).orElse(null);
        ...
        BloodUnit unit14 = bloodUnitService.getBloodUnitById(14).orElse(null);
        ...
        BloodUnit unit16 = bloodUnitService.getBloodUnitById(16).orElse(null);
        ...
        BloodUnit unit17 = bloodUnitService.getBloodUnitById(17).orElse(null);
        ...
        BloodUnit unit18 = bloodUnitService.getBloodUnitById(18).orElse(null);
        ...
        BloodUnit unit19 = bloodUnitService.getBloodUnitById(19).orElse(null);
        ...
        BloodUnit unit20 = bloodUnitService.getBloodUnitById(20).orElse(null);
    ...
    private void generateEventResponsiblePersons() {
        ...
        Person staff = personService.getPersonById(1).orElse(null);
        DonationEvent event = donationEventService.getDonationEventById(1).orElse(null);
        ...
        // 1
        Person staff1 = personService.getPersonById(1).orElse(null);
        DonationEvent event1 = donationEventService.getDonationEventById(1).orElse(null);
        ...
        // 2
        Person staff2 = personService.getPersonById(2).orElse(null);
        DonationEvent event2 = donationEventService.getDonationEventById(2).orElse(null);
        ...
        // 3
        Person staff3 = personService.getPersonById(3).orElse(null);
        DonationEvent event3 = donationEventService.getDonationEventById(3).orElse(null);
        ...
        // 4
        Person staff4 = personService.getPersonById(4).orElse(null);
        DonationEvent event4 = donationEventService.getDonationEventById(4).orElse(null);
        ...
        // 5
        Person staff5 = personService.getPersonById(5).orElse(null);
        DonationEvent event5 = donationEventService.getDonationEventById(5).orElse(null);
        ...
        // 7
        Person staff7 = personService.getPersonById(7).orElse(null);
        DonationEvent event7 = donationEventService.getDonationEventById(7).orElse(null);
        ...
        // 8
        Person staff8 = personService.getPersonById(8).orElse(null);
        DonationEvent event8 = donationEventService.getDonationEventById(8).orElse(null);
        ...
        // 10
        Person staff10 = personService.getPersonById(10).orElse(null);
        DonationEvent event10 = donationEventService.getDonationEventById(10).orElse(null);
        ...
        // 11
        Person staff11 = personService.getPersonById(11).orElse(null);
        DonationEvent event11 = donationEventService.getDonationEventById(11).orElse(null);
        ...
        // 12
        Person staff12 = personService.getPersonById(12).orElse(null);
        DonationEvent event12 = donationEventService.getDonationEventById(12).orElse(null);
        ...
        // 13
        Person staff13 = personService.getPersonById(13).orElse(null);
        DonationEvent event13 = donationEventService.getDonationEventById(13).orElse(null);
        ...
        // 14
        Person staff14 = personService.getPersonById(14).orElse(null);
        DonationEvent event14 = donationEventService.getDonationEventById(14).orElse(null);
        ...
        // 15
        Person staff15 = personService.getPersonById(15).orElse(null);
        DonationEvent event15 = donationEventService.getDonationEventById(15).orElse(null);
        ...
        // 16
        Person staff16 = personService.getPersonById(16).orElse(null);
        DonationEvent event16 = donationEventService.getDonationEventById(16).orElse(null);
        ...
        // 17
        Person staff17 = personService.getPersonById(17).orElse(null);
        DonationEvent event17 = donationEventService.getDonationEventById(17).orElse(null);
        ...
        // 19
        Person staff19 = personService.getPersonById(19).orElse(null);
        DonationEvent event19 = donationEventService.getDonationEventById(19).orElse(null);
        ...
        // 20
        Person staff20 = personService.getPersonById(20).orElse(null);
        DonationEvent event20 = donationEventService.getDonationEventById(20).orElse(null);
    ...
    private void generateTransfusions() {
        
        BloodUnit unit = bloodUnitService.getBloodUnitById(1).orElse(null);
        Person staff = personService.getPersonById(1).orElse(null);
        Person receptor = personService.getPersonById(2).orElse(null);

        Transfusion transfusion = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion")
        ...
        // 1
        BloodUnit unit1 = bloodUnitService.getBloodUnitById(1).orElse(null);
        Person staff1 = personService.getPersonById(2).orElse(null);
        Person receptor1 = personService.getPersonById(3).orElse(null);

        Transfusion transfusion1 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 1")
        ...
        // 2
        BloodUnit unit2 = bloodUnitService.getBloodUnitById(2).orElse(null);
        Person staff2 = personService.getPersonById(4).orElse(null);
        Person receptor2 = personService.getPersonById(5).orElse(null);

        Transfusion transfusion2 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 2")
        ...
        // 3
        BloodUnit unit3 = bloodUnitService.getBloodUnitById(3).orElse(null);
        Person staff3 = personService.getPersonById(6).orElse(null);
        Person receptor3 = personService.getPersonById(7).orElse(null);

        Transfusion transfusion3 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 3")
        ...
        // 4
        BloodUnit unit4 = bloodUnitService.getBloodUnitById(4).orElse(null);
        Person staff4 = personService.getPersonById(8).orElse(null);
        Person receptor4 = personService.getPersonById(9).orElse(null);

        Transfusion transfusion4 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 4")
        ...
        // 5
        BloodUnit unit5 = bloodUnitService.getBloodUnitById(5).orElse(null);
        Person staff5 = personService.getPersonById(10).orElse(null);
        Person receptor5 = personService.getPersonById(11).orElse(null);

        Transfusion transfusion5 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 5")
        ...
        Person receptor6 = personService.getPersonById(13).orElse(null);

        Transfusion transfusion6 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 6")
        ...
        // 7
        BloodUnit unit7 = bloodUnitService.getBloodUnitById(7).orElse(null);
        Person staff7 = personService.getPersonById(14).orElse(null);
        Person receptor7 = personService.getPersonById(15).orElse(null);

        Transfusion transfusion7 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 7")
        ...
        // 8
        BloodUnit unit8 = bloodUnitService.getBloodUnitById(8).orElse(null);
        Person staff8 = personService.getPersonById(16).orElse(null);
        Person receptor8 = personService.getPersonById(17).orElse(null);

        Transfusion transfusion8 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 8")
        ...
        // 9
        BloodUnit unit9 = bloodUnitService.getBloodUnitById(9).orElse(null);
        Person staff9 = personService.getPersonById(18).orElse(null);
        Person receptor9 = personService.getPersonById(19).orElse(null);

        Transfusion transfusion9 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 9")
        ...
        // 10
        BloodUnit unit10 = bloodUnitService.getBloodUnitById(10).orElse(null);
        Person staff10 = personService.getPersonById(20).orElse(null);
        Person receptor10 = personService.getPersonById(21).orElse(null);

        Transfusion transfusion10 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 10")
        ...
        // 11
        BloodUnit unit11 = bloodUnitService.getBloodUnitById(11).orElse(null);
        Person staff11 = personService.getPersonById(22).orElse(null);
        Person receptor11 = personService.getPersonById(23).orElse(null);

        Transfusion transfusion11 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 11")
        ...
        // 12
        BloodUnit unit12 = bloodUnitService.getBloodUnitById(12).orElse(null);
        Person staff12 = personService.getPersonById(24).orElse(null);
        Person receptor12 = personService.getPersonById(25).orElse(null);

        Transfusion transfusion12 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 12")
        ...
        // 13
        BloodUnit unit13 = bloodUnitService.getBloodUnitById(13).orElse(null);
        Person staff13 = personService.getPersonById(26).orElse(null);
        Person receptor13 = personService.getPersonById(27).orElse(null);

        Transfusion transfusion13 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 13")
        ...
        // 14
        BloodUnit unit14 = bloodUnitService.getBloodUnitById(14).orElse(null);
        Person staff14 = personService.getPersonById(28).orElse(null);
        Person receptor14 = personService.getPersonById(29).orElse(null);

        Transfusion transfusion14 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 14")
        ...
        // 15
        BloodUnit unit15 = bloodUnitService.getBloodUnitById(15).orElse(null);
        Person staff15 = personService.getPersonById(30).orElse(null);
        Person receptor15 = personService.getPersonById(31).orElse(null);

        Transfusion transfusion15 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 15")
        ...
        // 16
        BloodUnit unit16 = bloodUnitService.getBloodUnitById(16).orElse(null);
        Person staff16 = personService.getPersonById(32).orElse(null);
        Person receptor16 = personService.getPersonById(33).orElse(null);

        Transfusion transfusion16 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 16")
        ...
        // 17
        BloodUnit unit17 = bloodUnitService.getBloodUnitById(17).orElse(null);
        Person staff17 = personService.getPersonById(34).orElse(null);
        Person receptor17 = personService.getPersonById(35).orElse(null);

        Transfusion transfusion17 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 17")
        ...
        // 18
        BloodUnit unit18 = bloodUnitService.getBloodUnitById(18).orElse(null);
        Person staff18 = personService.getPersonById(36).orElse(null);
        Person receptor18 = personService.getPersonById(37).orElse(null);

        Transfusion transfusion18 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 18")
        ...
        // 19
        BloodUnit unit19 = bloodUnitService.getBloodUnitById(19).orElse(null);
        Person staff19 = personService.getPersonById(38).orElse(null);
        Person receptor19 = personService.getPersonById(39).orElse(null);

        Transfusion transfusion19 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 19")
        ...
        // 20
        BloodUnit unit20 = bloodUnitService.getBloodUnitById(20).orElse(null);
        Person staff20 = personService.getPersonById(40).orElse(null);
        Person receptor20 = personService.getPersonById(41).orElse(null);

        Transfusion transfusion20 = Transfusion.builder()
                .transfusionDate(new Date())
                .observations("Observations about the transfusion 20")
